...
const Home = () => {
  ...
  return (
    ...
    <section id="hero" className="d-flex align-items-center" style={{marginTop: "0", paddingTop:"0"}}>

        <div className="container">
          <div className="row gy-4">
            <div className="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
              <h1>Better Technology, Better Agriculture, Better Future</h1>
              <h2>Team Kisan provides you with a solution to improve lives of farmers</h2>
              <div>
                <a href="#about" className="btn-get-started scrollto">Get Started</a>
              </div>
            </div>
            <div className="col-lg-6 order-1 order-lg-2 hero-img d-flex justify-content-end align-items-end">
              <img src={require("../assets/img/carou.png")} className="img-fluid animated" alt=""/>
            </div>
          </div>
        </div>
    ...
    <main id="main">
        ...
        <section id="about" className="about" style={{paddingTop: "60px"}}>
            <div className="container">
              ...
              <div className="row justify-content-between">
                <div className="col-lg-5 d-flex align-items-center justify-content-center about-img">
                  <img src={require("../assets/img/plant-3.png")} className="img-fluid animated" alt="" data-aos="zoom-in" height="900" width="900"/>
                </div>
                <div className="col-lg-6 pt-5 pt-lg-0">
                  <h3 data-aos="fade-up">Why to use our website?</h3>
                  <p data-aos="fade-up" data-aos-delay="100">
                    This website provides one-platform for the farmers as well as the comapnies to improve their production and efficient use of the harvest.
                  </p>
                  ...
                  <div className="row">
                    <div className="col-md-6" data-aos="fade-up" data-aos-delay="100">
                      ...
                      <h4>For Companies</h4>
                      <p>Companies can get the data related to crop harvesting and their quality and use it to schedule their production</p>
                    </div>
                    <div className="col-md-6" data-aos="fade-up" data-aos-delay="200">
                      <i className="bx bx-cube-alt"></i>
                      <h4>For Farmers</h4>
                      <p>Farmers can use various features such as- weather alerts, best farming practices and pest control</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* ======= Services Section ======= */}
    <section id="services" className="services section-bg" style={{paddingTop: "100px"}}>
